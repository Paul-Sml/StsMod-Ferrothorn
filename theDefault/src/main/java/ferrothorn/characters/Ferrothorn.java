...
import ferrothorn.relics.IronBarbs;
...
import static ferrothorn.FerrothornMod.*;
import static ferrothorn.characters.Ferrothorn.Enums.COLOR_FERROTHORN;

//Wiki-page https://github.com/daviscook477/BaseMod/wiki/Custom-Characters
//and https://github.com/daviscook477/BaseMod/wiki/Migrating-to-5.0
//All text (starting description and loadout, anything labeled TEXT[]) can be found in DefaultMod-character-Strings.json in the resources

public class Ferrothorn extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass FERROTHORN;
        @SpireEnum(name = "FERROTHORN_COLOR") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor COLOR_FERROTHORN;
        @SpireEnum(name = "FERROTHORN_COLOR") @SuppressWarnings("unused")
    ...
    public static final String[] orbTextures = {
            ...
            "ferrothornResources/images/char/defaultCharacter/orb/layer4.png",
            "ferrothornResources/images/char/defaultCharacter/orb/layer5.png",
            "ferrothornResources/images/char/defaultCharacter/orb/layer6.png",
            "ferrothornResources/images/char/defaultCharacter/orb/layer1d.png",
    ...
    public AbstractCard.CardColor getCardColor() {
        return COLOR_FERROTHORN;
    }

    // Should return a color object to be used to color the trail of moving cards
    @Override
    public Color getCardTrailColor() {
        return FerrothornMod.FERROTHORN_GREEN.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new Ferrothorn(name, chosenClass);
    }
