...
public class SandstormEffect extends AbstractGameEffect {
    ...
    public SandstormEffect() {
        ...
        this.color = new Color(CardHelper.getColor(MathUtils.random(190,200),MathUtils.random(170,180),MathUtils.random(120,130))).cpy();
        this.duration = 4.0F;
    }
    ...
    private void renderImg(SpriteBatch sb, Texture img, boolean flipH, boolean flipV) {
        ...
        this.color.a = MathUtils.random(0.6F, 0.90F);
    }
}