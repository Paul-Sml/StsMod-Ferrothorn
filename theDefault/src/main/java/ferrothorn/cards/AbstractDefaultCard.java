...
public abstract class AbstractDefaultCard extends CustomCard {
    ...
    public AbstractCard makeStatEquivalentCopy() {
        ...
        ExhaustiveField.ExhaustiveFields.baseExhaustive.set(copy, ExhaustiveField.ExhaustiveFields.baseExhaustive.get(this));
        ExhaustiveField.ExhaustiveFields.exhaustive.set(copy, ExhaustiveField.ExhaustiveFields.exhaustive.get(this));
        ExhaustiveField.ExhaustiveFields.isExhaustiveUpgraded.set(copy, ExhaustiveField.ExhaustiveFields.isExhaustiveUpgraded.get(this));
